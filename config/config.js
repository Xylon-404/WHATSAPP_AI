...
// On Render with a persistent disk mounted at /opt/render/project/src/auth_info
// this relative resolution works perfectly. Override with AUTH_DIR if needed.
...
const DEV_CONTACT_URL = 'https://collegemate.xyz/';
const DEV_TELEGRAM = 't.me/PRO_CODE_X';
...
// xylon-404
// xylon-404
// ── Self-ping (keeps free hosting tiers awake) ──
const SELF_URL = process.env.RENDER_EXTERNAL_URL || process.env.SELF_URL || '';
const SELF_PING_INTERVAL_MS = 13 * 60 * 1000;
